...
- (int)loadSDKConfigWithSecretId:(NSString *)secretId
                   withSecretKey:(NSString *)secretKey
                      withConfig:(OcrSDKConfig *)ocrSDKConfig;
...
- (void)startProcessOcr:(int)ocrType withSDKUIConfig:(CustomConfigUI *)ocrSDKUIConfig
...
- (void)updateFederationToken:(NSString *_Nonnull)
tmpSecretId withTempSecretKey:(NSString *_Nullable)tmpSecretKey
