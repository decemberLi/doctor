...
class SpinnerInput extends StatefulWidget {
  ...
  SpinnerInput({
    ...
    this.middleNumberStyle = const TextStyle(fontSize: 17),
    this.maxValue: 100,
    this.minValue: 0,
    this.step: 1,
...
class _SpinnerInputState extends State<SpinnerInput>
  ...
  void initialize() {
    ...
    _plusSpinnerStyle.width ??= 30;
    _plusSpinnerStyle.height ??= 30;
    ...
    _minusSpinnerStyle.child ??= Icon(Icons.remove, size: 16);
    ...
    _minusSpinnerStyle.width ??= 30;
    _minusSpinnerStyle.height ??= 30;
    ...
    _popupButtonStyle.child ??= Icon(Icons.check, size: 17);
    ...
    _popupButtonStyle.width ??= 30;
    _popupButtonStyle.height ??= 30;
    _popupButtonStyle.elevation ??= 0;
  ...
  @override
  void didUpdateWidget(SpinnerInput oldWidget) {
    initialize();
  ...
  void increase() {
    ...
    if (value <= widget.maxValue) {
      ...
      EasyLoading.showToast('数量不能大于90天最大处方量');
    }
  }
  ...
  void decrease() {
    ...
    if (value >= widget.minValue) {
      ...
      EasyLoading.showToast('数量不能小于${widget.minValue.toStringAsFixed(0)}');
    }
  }
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: RaisedButton(
                          ...
                          highlightElevation:
                              _popupButtonStyle.highlightElevation,
                          shape: new RoundedRectangleBorder(
