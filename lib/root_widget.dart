    ...
    MedcloudsNativeApi.instance().addProcessor(
      ...
      (args) async {
        ...
        try {
          ...
          // var type = message["bizType"];
          // if (type == "QUALIFICATION_AUTH") {
          //   print("the obj is ---- $message");
          //   // 资质认证
          //   var authStatus = message["authStatus"];
          //   if (authStatus == "FAIL") {
          ...
          //   var template = message['taskTemplate'];
          //   if (template == 'MEDICAL_SURVEY') {
          //     if (model.data.authStatus == 'PASS') {
          //       var learnPlanId = message["learnPlanId"];
          ...
          //   if (message['activityType'] == 'CASE_COLLECTION') {
          //     // 病例驳回 || RWS 驳回 go 资料详情
          //     Navigator.push(context, MaterialPageRoute(builder: (context) {
          //       return ActivityResourceDetailPage(
          //         message['activityPackageId'],
          //         message['activityTaskId'],
          //         status: VERIFY_STATUS_REJECT,
          //         rejectReason: message['rejectReason'],
          //       );
          //     }));
          //   } else if (message['activityType'] == 'MEDICAL_SURVEY' || obj['activityType'] == 'RWS') {
          //     // go 医学调研驳回 资料详情
          //     Navigator.push(context, MaterialPageRoute(builder: (context) {
          //       return ActivityResearch(message['activityPackageId'], activityTaskId: obj['activityTaskId'],);
          //     }));
          //   }
          ...
          //         message['activityPackageId'], message['activityType']);
          //   }));
          // } else if (type == "") {}
        } catch (e) {}
      },
