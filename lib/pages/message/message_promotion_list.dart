                      ...
                      itemBuilder:(context,item,model){
                       return _MessageStudyCell(
                         ...
                         onTap: (data){
                           ...
                           if (data.params == null || data.params['learnPlanId'] == null) {
                             return;
                           }
...
class _SubCollectList extends StatefulWidget {
  final Widget Function(BuildContext,MessageListEntity,MessageListModel) itemBuilder;
  final String type;
...
class _SubCollectState extends State<_SubCollectList> {
  ...
  Widget content(BuildContext context,MessageListModel model) {
    Widget child = Center(
      child: ViewStateEmptyWidget(message: "给我一点学习成长的机会",),
    );
